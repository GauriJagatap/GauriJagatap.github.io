...
Using fraction of actual samples, chosen uniformly at random:
...
Keeping only a fraction of the cameras "ON", chosen uniformly at random:
...
Reducing overlap between consecutive cameras:
